...
const displayConfig = {
  ...
  selectString: {
    // WIP for the new graph views. This will probably need to become a
    // recursive query in a stored procedure.
    chemical:
      "id, name: data->name, inchi: data->inchi, inchi_key: data->inchi_key",
  },
  joinLimits: {
